...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.techorin.cinema.service.impl.PasswordTokenManager#generateRecoveryToken(com.techorin.cinema.model.User)
     */
    @Override
    ...
    /**
     * @see com.techorin.cinema.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.techorin.cinema.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.techorin.cinema.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
